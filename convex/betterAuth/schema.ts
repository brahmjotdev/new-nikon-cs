...
export const tables = {
  user: defineTable({
    ...
    approved: v.boolean(), // custom: admin to approve new users
    //==============================
  ...
  // Custom: agent password reset requests (username only; admin resolves)
  agentPasswordResetRequests: defineTable({
    username: v.string(),
    createdAt: v.number(),
